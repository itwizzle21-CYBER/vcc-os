...
import { CompanionArt, VCC_COMPANIONS, type VccCompanion } from "./Companions";

export { CompanionArt, VCC_COMPANIONS } from "./Companions";
export type { VccCompanion } from "./Companions";
